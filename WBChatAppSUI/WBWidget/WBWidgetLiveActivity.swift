...
struct WBWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = WBWidgetAttributes(name: "Me")
    static let contentState = WBWidgetAttributes.ContentState(value: 3)
